...
│   │   │   │       ├── PluginBuilder/        # 🧩 可视化插件构建器
│   │   │   │       ├── PluginWizard/         # 🎯 新手引导向导
│   │   │   │       ├── PartEditor/           # 部件编辑器
│   │   │   │       ├── PartWorkshop/         # 🎨 零件工坊 (16+ 零件)
│   │   │   │       ├── QuoteManager/         # 名言管理器
│   │   │   │       ├── RssManager/           # RSS 管理器
│   │   │   │       ├── VisitsManager/        # 访问管理器
│   │   │   │       ├── NotesManager/         # 笔记管理器
...
2. **设置安全密码**
   - 在 `.env` 文件中设置 `YOUR_PASSWORD`（至少8位）
   - 系统会自动根据密码生成安全密钥
...
2. **设置安全密码**：在 `.env` 中设置 `YOUR_PASSWORD`，系统自动生成安全密钥
