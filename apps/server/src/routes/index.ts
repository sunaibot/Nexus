...
// ========== 核心功能路由 ==========
export { default as bookmarksRouter } from './v2/bookmarks.js'
export { default as categoriesRouter } from './v2/categories.js'
...
export { default as rssRouter } from './v2/rss.js'
export { default as notesRouter } from './v2/notes.js'
export { default as notepadsRouter } from './v2/notepads.js'
export { default as quotesRouter } from './v2/quotes.js'
export { default as widgetsRouter } from './v2/widgets.js'
export { default as serviceMonitorsRouter } from './v2/service-monitors.js'
export { default as customMetricsRouter } from './v2/custom-metrics.js'
export { default as visitsRouter } from './v2/visits.js'
