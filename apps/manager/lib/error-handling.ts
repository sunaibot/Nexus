...
export function getErrorMessage(error: unknown): string {
  console.log('[getErrorMessage] Received error:', error)
  ...
  if (error instanceof ApiError) {
    console.log('[getErrorMessage] It is an ApiError, message:', error.message)
  ...
  try {
    ...
    console.log('[getErrorMessage] Stringified error:', str)
    if (str && str !== '{}') {
      return str
    }
  } catch {
    console.log('[getErrorMessage] Failed to stringify error')
  }
