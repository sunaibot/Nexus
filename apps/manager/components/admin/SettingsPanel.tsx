...
interface SettingsPanelProps {
  ...
  // 私密密码设置
  privatePasswordStatus: import('../../hooks/usePrivatePassword').PrivatePasswordStatus | null
  isLoadingPrivatePassword: boolean
  privatePasswordError: string | null
  privatePasswordSuccess: boolean
  onSetPrivatePassword: (password: string) => Promise<void>
  onUpdatePrivatePassword: (oldPassword: string, newPassword: string) => Promise<void>
  onDeletePrivatePassword: (password: string) => Promise<void>
  onDisablePrivatePassword: () => Promise<void>
  onEnablePrivatePassword: () => Promise<void>
  onRefreshPrivatePasswordStatus: () => Promise<void>
  onClearPrivatePasswordError: () => void
  onClearPrivatePasswordSuccess: () => void
  // 数据管理
  bookmarks: Bookmark[]
  categories: Category[]
...
export function SettingsPanel({
  ...
  // 私密密码设置
  privatePasswordStatus,
  isLoadingPrivatePassword,
  privatePasswordError,
  privatePasswordSuccess,
  onSetPrivatePassword,
  onUpdatePrivatePassword,
  onDeletePrivatePassword,
  onDisablePrivatePassword,
  onEnablePrivatePassword,
  onRefreshPrivatePasswordStatus,
  onClearPrivatePasswordError,
  onClearPrivatePasswordSuccess,
  // 数据管理
  bookmarks,
  categories,
  onImport,
      ...
      <div>
          ...
          {activeSettingsTab === 'security' && (
            <div className="space-y-6">
              ...
              />
              <PrivatePasswordCard
                status={privatePasswordStatus}
                isLoading={isLoadingPrivatePassword}
                error={privatePasswordError}
                success={privatePasswordSuccess}
                onSetPassword={onSetPrivatePassword}
                onUpdatePassword={onUpdatePrivatePassword}
                onDeletePassword={onDeletePrivatePassword}
                onDisable={onDisablePrivatePassword}
                onEnable={onEnablePrivatePassword}
                onRefresh={onRefreshPrivatePasswordStatus}
              />
            </div>
          )}
