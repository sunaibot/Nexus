  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* 天气显示 */}
        {showWeather && weather && (
          <WeatherDisplay weather={weather} loading={weatherLoading ?? false} onRefresh={onRefreshWeather} />
        )}
      </motion.div>
      ...
      {/* Search Hint */}
      <SearchHint isLiteMode={isLiteMode ?? false} onOpenSearch={onOpenSearch} />
    </motion.section>
  );
}
